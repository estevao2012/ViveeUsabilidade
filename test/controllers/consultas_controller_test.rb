...
class ConsultasControllerTest < ActionController::TestCase
  ...
  test "should create consulta" do
    assert_difference('Consulta.count') do
      post :create, consulta: { data: @consulta.data, medico_id: @consulta.medico_id, user_id: @consulta.user_id }
    end
  ...
  test "should update consulta" do
    patch :update, id: @consulta, consulta: { data: @consulta.data, medico_id: @consulta.medico_id, user_id: @consulta.user_id }
    assert_redirected_to consulta_path(assigns(:consulta))
  end
