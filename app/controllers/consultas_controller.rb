class ConsultasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @consulta.save
        format.html { redirect_to :back, notice: 'Consulta marcada com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @consulta.update(consulta_params)
        format.html { redirect_to :back, notice: 'Consulta was successfully updated.' }
  ...
  private
    ...
    def consulta_params
      params.require(:consulta).permit(:data, :medico_id, :usuario_id)
    end
end
